...
class ta_lib:
    ...
    def isOnBollDown(df,P):
        df['isOnBollDown']=np.sign(df['close_0']-df['bolldown_90_2_2_0'])  
        return df
    ...
    def basic(df,p): 
        ...
        df['turnover-rate']=df_basic['turnover_rate']
        df['turnover-rate-f']=df_basic['turnover_rate_f']
        df['volume-ratio']=df_basic['volume_ratio']
        df['pe']=df_basic['pe']
        df['pe-ttm']=df_basic['pe_ttm']
        df['pb']=df_basic['pb']
        df['ps']=df_basic['ps']
        df['ps-ttm']=df_basic['ps_ttm']
        df['dv-ratio']=df_basic['dv_ratio']
        df['dv-ttm']=df_basic['dv_ttm']
        df['total-share']=df_basic['total_share']
        df['float-share']=df_basic['float_share']
        df['free-share']=df_basic['free_share']
        df['total-mv']=df_basic['total_mv']
        df['circ-mv']=df_basic['circ_mv']
        return df
