...
class alpha101:
    ...
    def getalpha101(df,p):
                df_tmp=df
                stock=Alphas(df_tmp.copy(deep=True))
                df['alpha101-001']=stock.alpha001() 
                df['alpha101-002']=stock.alpha002()
                df['alpha101-003']=stock.alpha003()
                df['alpha101-004']=stock.alpha004()
                df['alpha101-005']=stock.alpha005()
                df['alpha101-006']=stock.alpha006()
                df['alpha101-007']=stock.alpha007()
                df['alpha101-008']=stock.alpha008()
                df['alpha101-009']=stock.alpha009()
                df['alpha101-010']=stock.alpha010()
                df['alpha101-011']=stock.alpha011()
                df['alpha101-012']=stock.alpha012()
                df['alpha101-013']=stock.alpha013()
                df['alpha101-014']=stock.alpha014()
                df['alpha101-015']=stock.alpha015()
                df['alpha101-016']=stock.alpha016()
                df['alpha101-017']=stock.alpha017()
                df['alpha101-018']=stock.alpha018()
                df['alpha101-019']=stock.alpha019()
                df['alpha101-020']=stock.alpha020()
                df['alpha101-021']=stock.alpha021()
                df['alpha101-022']=stock.alpha022()
                df['alpha101-023']=stock.alpha023()
                df['alpha101-024']=stock.alpha024()
                df['alpha101-025']=stock.alpha025()
                df['alpha101-026']=stock.alpha026()
                df['alpha101-027']=stock.alpha027()
                df['alpha101-028']=stock.alpha028()
                df['alpha101-029']=stock.alpha029()
                df['alpha101-030']=stock.alpha030()
                df['alpha101-031']=stock.alpha031()
                df['alpha101-032']=stock.alpha032()
                df['alpha101-033']=stock.alpha033()
                df['alpha101-034']=stock.alpha034()
                df['alpha101-035']=stock.alpha035()
                df['alpha101-036']=stock.alpha036()
                df['alpha101-037']=stock.alpha037()
                df['alpha101-038']=stock.alpha038()
                df['alpha101-039']=stock.alpha039()
                df['alpha101-040']=stock.alpha040()
                df['alpha101-041']=stock.alpha041()
                df['alpha101-042']=stock.alpha042()
                df['alpha101-043']=stock.alpha043()
                df['alpha101-044']=stock.alpha044()
                df['alpha101-045']=stock.alpha045()
                df['alpha101-046']=stock.alpha046()
                df['alpha101-047']=stock.alpha047()
                df['alpha101-049']=stock.alpha049()
                df['alpha101-050']=stock.alpha050()
                df['alpha101-051']=stock.alpha051()
                df['alpha101-052']=stock.alpha052()
                df['alpha101-053']=stock.alpha053()
                df['alpha101-054']=stock.alpha054()
                df['alpha101-055']=stock.alpha055()
                df['alpha101-057']=stock.alpha057()
                df['alpha101-060']=stock.alpha060()
                df['alpha101-061']=stock.alpha061()
                df['alpha101-062']=stock.alpha062()
                df['alpha101-064']=stock.alpha064()
                df['alpha101-065']=stock.alpha065()
                df['alpha101-066']=stock.alpha066()
                df['alpha101-068']=stock.alpha068()
                df['alpha101-071']=stock.alpha071()
                df['alpha101-072']=stock.alpha072()
                df['alpha101-073']=stock.alpha073()
                df['alpha101-074']=stock.alpha074()
                df['alpha101-075']=stock.alpha075()
                df['alpha101-077']=stock.alpha077()
                df['alpha101-078']=stock.alpha078()
                df['alpha101-081']=stock.alpha081()
                df['alpha101-083']=stock.alpha083()
                df['alpha101-084']=stock.alpha084()
                df['alpha101-085']=stock.alpha085()
                df['alpha101-086']=stock.alpha086()
                df['alpha101-088']=stock.alpha088()
                df['alpha101-092']=stock.alpha092()
                df['alpha101-094']=stock.alpha094()
                df['alpha101-095']=stock.alpha095()
                df['alpha101-096']=stock.alpha096()
                df['alpha101-098']=stock.alpha098()
                df['alpha101-099']=stock.alpha099()
                df['alpha101-101']=stock.alpha101()  
